...
This customer has a tenure level, the number of months this person has used our product/service.
Project Dataset

The dataset represents a customer base from a Telco company containing individual customer data on the products and services (like internet type, online security, online backup, tech support), account information (like contract type, payment method, monthly charges) and profile (like gender, partner, dependents).
